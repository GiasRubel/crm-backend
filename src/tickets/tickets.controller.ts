...
export class TicketsController {
  ...
  findAll(
    ...
    return this.ticketsService.findAll(query, user.sub);
  }

  @Get('stats')
  @Roles(AppRole.Admin, AppRole.Administrator, AppRole.User)
  getStats(@CurrentUser() user: KeycloakJwtPayload) {
    return this.ticketsService.getStats(user.sub);
  }
  ...
  setStatus(
    ...
    return this.ticketsService.setStatus(id, dto, user.sub);
  }
  ...
  addComment(
    ...
    return this.ticketsService.addComment(id, dto, user.sub);
  }
